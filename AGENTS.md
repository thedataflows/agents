...
- DO NOT use stupid jargon and words like "fold" instead of "write" or "mutation" Use standard technical English when communicating to humans, always use `unslop` skill
